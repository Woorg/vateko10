...
class Advantages extends Block
{
    public function __construct(Application $app)
    {
         ...
         * @var string
         */
        $this->name = __('Преимущества эковаты Ватэко', 'sage');
         ...
         * @var string
         */
        $this->description = __('A simple Advantages block.', 'sage');
     ...
     * @return array
     */
    public function advantages_title()
    {
        return get_field('advantages_title');
    }
