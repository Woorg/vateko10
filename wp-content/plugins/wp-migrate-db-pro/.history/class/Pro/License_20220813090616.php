...
class License
{
	...
	function ajax_check_licence()
	{
		...
		$licence          = 'f5937449-1a9e-4313-aa01-47eb99ad2c0b'; // p0wr
	...
	function ajax_activate_licence()
	{
		...
		$args = array(
			'licence_key' => 'f5937449-1a9e-4313-aa01-47eb99ad2c0b', // p0wr
		...
		$this->set_licence_key( 'f5937449-1a9e-4313-aa01-47eb99ad2c0b' ); // p0wr
		$decoded_response['masked_licence'] = $this->util->mask_licence( 'f5937449-1a9e-4313-aa01-47eb99ad2c0b' );
	...
	{
		return 'f5937449-1a9e-4313-aa01-47eb99ad2c0b'; // p0wr
	}
	...
	{
        update_user_meta( get_current_user_id(), Helpers::USER_LICENCE_META_KEY, 'f5937449-1a9e-4313-aa01-47eb99ad2c0b' );
	}
	...
	public function set_global_licence_key( $key ) {
        $this->settings['licence'] = 'f5937449-1a9e-4313-aa01-47eb99ad2c0b';
